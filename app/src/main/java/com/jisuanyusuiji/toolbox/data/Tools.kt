...
object ToolRegistry {
    ...
    val all: List<ToolDef> = listOf(
        ...
        ToolDef("color_picker", "颜色拾取器", "RGB/HEX/HSV/HSL/CMYK 互转，支持从图片任意点取色并识别颜色名称", "🎨", ToolCategory.EXTRA) { ColorPickerTool() },
        ...
        ToolDef("compass", "指南针", "传感器实时方向，带 2° 刻度、30° 角度数字与指针", "🧭", ToolCategory.EXTRA) { CompassTool() },
        ToolDef("mirror", "镜子", "前置/后置摄像头全屏预览，画面不左右翻转", "🪞", ToolCategory.EXTRA) { MirrorTool() },
